            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="sid" class="col-md-4 col-form-label text-md-right">{{ __('Student Number') }}</label>
                            <div class="col-md-6">
                                <input id="sid" type="text" class="form-control{{ $errors->has('sid') ? ' is-invalid' : '' }}" name="sid" value="{{ old('sid') }}" required>
                                @if ($errors->has('sid'))
                                <span class="invalid-feedback">
